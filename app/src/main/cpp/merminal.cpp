...
Java_cn_mucute_merminal_core_JNI_setPtyWindowSize(JNIEnv *TERMUX_UNUSED(env),
                                                  jclass TERMUX_UNUSED(clazz),
                                                  jint fd, jint rows,
                                                  jint cols) {
...
extern "C" JNIEXPORT void JNICALL
Java_cn_mucute_merminal_core_JNI_setPtyUTF8Mode(JNIEnv *TERMUX_UNUSED(env),
                                                jclass TERMUX_UNUSED(clazz),
                                                jint fd) {
    struct termios tios{};
    tcgetattr(fd, &tios);
...
Java_cn_mucute_merminal_core_JNI_waitFor(JNIEnv *TERMUX_UNUSED(env), jclass TERMUX_UNUSED(clazz),
                                         jint pid) {
    int status;
...
extern "C" JNIEXPORT void JNICALL
Java_cn_mucute_merminal_core_JNI_close(JNIEnv *TERMUX_UNUSED(env), jclass TERMUX_UNUSED(clazz),
                                       jint fileDescriptor) {
